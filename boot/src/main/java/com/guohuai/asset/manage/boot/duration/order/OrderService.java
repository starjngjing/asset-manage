...
public class OrderService {
	...
	public void auditTrust(TrustForm form, String uid) {
		...
		entity.setOid(StringUtil.uuid());
		entity.setOrderOid(form.getOid());
		entity.setAuditType(TargetAuditEntity.TYPE_AUDIT + "-Purchase");
		entity.setAuditState(form.getState());
		entity.setAuditor(uid);
		entity.setAuditTime(DateUtil.getSqlCurrentDate());
	...
	public void appointMentForTrust(TrustForm form, String uid) {
		...
		entity.setOid(StringUtil.uuid());
		entity.setOrderOid(form.getOid());
		entity.setAuditType(TargetAuditEntity.TYPE_APPOINTMENT + "-Purchase");
		entity.setAuditState(form.getState());
		entity.setAuditor(uid);
		entity.setAuditTime(DateUtil.getSqlCurrentDate());
	...
	public void orderConfirmForTrust(TrustForm form, String uid) {
		...
		entity.setOid(StringUtil.uuid());
		entity.setOrderOid(form.getOid());
		entity.setAuditType(TargetAuditEntity.TYPE_CONFIRM + "-Purchase");
		entity.setAuditState(form.getState());
		entity.setAuditor(uid);
		entity.setAuditTime(DateUtil.getSqlCurrentDate());
	...
	public void auditTrustForIncome(TrustForm form, String uid) {
		...
		entity.setOid(StringUtil.uuid());
		entity.setOrderOid(form.getOid());
		entity.setAuditType(TargetAuditEntity.TYPE_AUDIT + "-Income");
		entity.setAuditState(form.getState());
		entity.setAuditor(uid);
		entity.setAuditTime(DateUtil.getSqlCurrentDate());
		...
		// 录入申购订单的审核信息
		TargetIncomeEntity order = this.getTargetIncomeOrderByOid(form.getOid());
	...
	public void orderConfirmForIncome(TrustForm form, String uid) {
		...
		entity.setOid(StringUtil.uuid());
		entity.setOrderOid(form.getOid());
		entity.setAuditType(TargetAuditEntity.TYPE_CONFIRM + "-Income");
		entity.setAuditState(form.getState());
		entity.setAuditor(uid);
		entity.setAuditTime(DateUtil.getSqlCurrentDate());
	...
	public void auditTrustForTransfer(TrustForm form, String uid) {
		...
		entity.setOid(StringUtil.uuid());
		entity.setOrderOid(form.getOid());
		entity.setAuditType(TargetAuditEntity.TYPE_AUDIT + "-Transfer");
		entity.setAuditState(form.getState());
		entity.setAuditor(uid);
		entity.setAuditTime(DateUtil.getSqlCurrentDate());
		...
		// 录入申购订单的审核信息
		TargetTransEntity order = this.getTargetTransOrderByOid(form.getOid());
		order.setAuditVolume(form.getVolume());
		order.setAuditor(uid);
		order.setUpdateTime(DateUtil.getSqlCurrentDate());
	...
	public void orderConfirmForTransfer(TrustForm form, String uid) {
		...
		entity.setOid(StringUtil.uuid());
		entity.setOrderOid(form.getOid());
		entity.setAuditType(TargetAuditEntity.TYPE_CONFIRM + "-Transfer");
		entity.setAuditState(form.getState());
		entity.setAuditor(uid);
		entity.setAuditTime(DateUtil.getSqlCurrentDate());
	...
	public TargetPurchaseEntity getTargetPurchaseOrderByOid(String oid) {
		TargetPurchaseEntity entity = targetPurchaseDao.findByOid(oid);
	 ...
	 * @return
	 */
	public TargetIncomeEntity getTargetIncomeOrderByOid(String oid) {
		TargetIncomeEntity entity = targetIncomeDao.findByOid(oid);
	 ...
	 * @return
	 */
	public TargetTransEntity getTargetTransOrderByOid(String oid) {
		TargetTransEntity entity = targetTransDao.findByOid(oid);
